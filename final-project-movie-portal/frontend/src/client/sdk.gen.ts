...
export const updateMe = <ThrowOnError extends boolean = false>(options: Options<UpdateMeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateMeResponses, unknown, ThrowOnError>({
        url: '/users/me',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const getCommentsByMovie = <ThrowOnError extends boolean = false>(options: Options<GetCommentsByMovieData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCommentsByMovieResponses, unknown, ThrowOnError>({
...
export const refreshAccessToken = <ThrowOnError extends boolean = false>(options: Options<RefreshAccessTokenData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RefreshAccessTokenResponses, unknown, ThrowOnError>({
...
export const getAllRoles = <ThrowOnError extends boolean = false>(options?: Options<GetAllRolesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllRolesResponses, unknown, ThrowOnError>({
        url: '/roles',
        ...options
    });
};

export const searchMovies = <ThrowOnError extends boolean = false>(options: Options<SearchMoviesData, ThrowOnError>) => {
